            ...
            <div className='text-xl font-bold'>
             ...
             <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <div className='flex justify-between w-full'>
                    ...
                    <div className='flex flex-col w-5/12 my-8'>
                        <label>Company</label>
                        <input defaultValue={formVal.company?formVal.company:''} type="text" className='rounded-t-lg rounded-b-lg h-10 px-4 border-slate-400 border-2' {...register("company",{required:true})}></input>
                    </div>
                </div>
