...
const snackBar = ({onClose,msg,classes,timeout}) => {
    ...
    const containerClass = classes.containerClass?classes.containerClass:'absolute top-0 left-0 w-full h-full flex justify-center items-end'
    const dimensionClass = classes.dimensionClass?classes.dimensionClass:'w-2/3 h-2/3'
    const wrapperClass = classes.wrapperClass?classes.wrapperClass:'h-16 w-80 bg-white px-4 py-6 rounded-2xl relative mb-16 bg-gray-800/75 text-slate-200 text-md font-semibold '
