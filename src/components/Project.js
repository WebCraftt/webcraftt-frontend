...
const Project = () => {
    const projects = [
        ...
        },
        {
            ...
            description: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed vitae ante a turpis tristique.',
            imageUrlLight: 'https://flowbite.s3.amazonaws.com/docs/device-mockups/laptop-screen.png',
            imageUrlDark: 'https://flowbite.s3.amazonaws.com/docs/device-mockups/laptop-screen-dark.png',
            techIcons: [<BiLogoReact />, <SiNextdotjs />, <BiLogoAws />, <BiLogoRedux />, <BiLogoMongodb />, <BiLogoNodejs />],
    ...
    return (
        <div className="w-full mx-auto rounded-t-xl relative">
            <h1
      ...
      tracking-tight leading-none md:text-4xl xl:text-5xl dark:text-white"
            >
                Our <span className="text-[#9dd4e8]">Works</span>
            </h1>
            <p className='text-center w-96 m-auto'>Lorem ipsum dolor quidem vitae porro quis nobis enim voluptates suscipit rerum nam?</p>
            <br />
                ...
                {projects?.map((project, index) => (
                    <div key={index} className="carousel-item mx-auto w-full">
                        ...
                        <div className="project-description w-[450px] m-auto absolute top-[59%] left-[-67.59%] bg-gray-800 p-5 hover:bg-blue-950">
                            ...
                            <br />
                            <a href={project.liveWebsiteUrl} className="view-live-button flex flex-row items-center">
                                <p className="mr-5 text-xl text-purple-600 border-2 px-4 bg-white">Live</p>
