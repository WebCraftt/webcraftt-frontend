...
const Testimonials = () => {
    ...
    return (
        <div className="bg-white dark:bg-gray-900 h-[90vh] flex items-center justify-center w-full">
            <div className='pt-36'>
                <h1 className="max-w-xl mx-auto text-4xl text-center m-auto font-extrabold tracking-tight leading-none md:text-5xl xl:text-6xl dark:text-white">What Client Say About <span className="text-[#9dd4e8]">WebCraft</span></h1>
                <div className="max-w-xl m-auto px-4 py-8 mx-auto text-center lg:py-16 lg:px-6">
                    <Carousel {...carouselOptions} className="max-w-screen-xl py-8 mx-auto text-center md:py-16"
                    >
