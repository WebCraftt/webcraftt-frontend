      ...
      >
        <div class="mt-8 overflow-hidden">
          <div class="grid grid-cols-1 md:grid-cols-2">
            <div class="h-fit p-6 mr-2 bg-gray-100 dark:bg-gray-800 sm:rounded-lg ">
              ...
              <div className="flex p-2 justify-start items-center">
                ...
                <svg
                  ...
                  class="h6 w-6 m-2  lg:transition-[3s]  lg:hover:scale-[130%]"
                  fill="currentColor"
                  viewBox="0 0 24 24"
                >
                ...
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  class="h-6 w-6 m-2 lg:transition-[3s]  lg:hover:scale-[130%]"
                  fill="currentColor"
                  viewBox="0 0 24 24"
                >
            ...
            <form class="p-6 flex flex-col justify-center">
              ...
              <div class="flex flex-col mt-2">
                ...
                <input
                  ...
                  class="w-100 mt-2 py-3 px-3 rounded-lg bg-white dark:bg-gray-800 border border-gray-400 
